...
// temperature and output-token state and its stable QML singleton API.
class GoogleProviderSettingsController : public ProviderSettingsControllerBase {
 ...
 public:
  ...
  explicit GoogleProviderSettingsController(const std::shared_ptr<holonight_providers::GoogleProvider>& probe_provider,
