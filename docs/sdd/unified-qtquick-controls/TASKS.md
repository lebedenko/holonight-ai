...
- [x] Inspect baselines, ownership, conventions and migration inventory.
- [x] Publish local design and umbrella In Progress checkpoint.
- [x] Migrate all application controls and executable discovery/default.
